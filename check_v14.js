...
function updateBoardLayout(){
  ...
  if(isMobileBoard()){
    // v14 mobile: larger board, tighter layer spacing, and a tight viewBox.
    // This keeps the board inside the phone width while using more of the available screen.
    CELL_W=104; CELL_H=56; SKEW_X=30;
    LAYER_LAYOUT={
      4:{ox:18,oy:150,color:'#7dd3fc',fill:'rgba(125,211,252,.060)',name:'Layer 4'},
      3:{ox:18,oy:325,color:'#67e8f9',fill:'rgba(103,232,249,.055)',name:'Layer 3'},
      2:{ox:18,oy:500,color:'#38bdf8',fill:'rgba(56,189,248,.060)',name:'Layer 2'},
      1:{ox:18,oy:675,color:'#0ea5e9',fill:'rgba(14,165,233,.065)',name:'Layer 1'}
    };
    if(svg){
      svg.setAttribute('viewBox','0 -48 492 780');
    ...
    LAYER_LAYOUT={4:{ox:210,oy:230,color:'#7dd3fc',fill:'rgba(125,211,252,.055)',name:'Layer 4'},3:{ox:210,oy:425,color:'#67e8f9',fill:'rgba(103,232,249,.050)',name:'Layer 3'},2:{ox:210,oy:620,color:'#38bdf8',fill:'rgba(56,189,248,.055)',name:'Layer 2'},1:{ox:210,oy:815,color:'#0ea5e9',fill:'rgba(14,165,233,.060)',name:'Layer 1'}};
    if(svg){svg.setAttribute('viewBox','0 0 980 1040');svg.style.height='980px';svg.style.maxWidth='';}
  }
}
